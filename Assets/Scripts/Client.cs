...
public class Client
{
   ...
   // public InterpolationHandler interpolationHandler = new InterpolationHandler(this);
    ...
    public class UDP
    {
        ...
        public void HandleData(Packet _packetData)
        {
            ...
            //TODO:if the packet is an input packet, send to another class' queue, whose fixed update will handle the packet seperately
            ...
            //    if(_packetId == 2)
            //    {
            //        InterpolationManager.instance.AddToQueue(_packet);
            //    }
            //}
